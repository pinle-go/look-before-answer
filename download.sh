...
wget -c https://rajpurkar.github.io/SQuAD-explorer/dataset/train-v2.0.json -O $SQUAD_DIR/train-v2.0.json
wget -c https://rajpurkar.github.io/SQuAD-explorer/dataset/dev-v2.0.json -O $SQUAD_DIR/dev-v2.0.json
